<template>
  <transition name="fade" mode="out-in">
    <div class="fixed h-full pb-24 md:pb-6 md:h-auto flex flex-col pt-6 px-6 bg-white gap-5 text-[#757575] text-base mt-12 left-0 right-0 border-t border-[#EEEEEE] border-solid overflow-y-scroll">
