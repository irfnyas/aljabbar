<template>
  <div class="relative max-w-[250px] h-[330px] rounded-lg overflow-hidden group">
    <div
      class="absolute w-full h-full bg-no-repeat bg-cover rounded-lg group-hover:scale-110 transition-all duration-500"
